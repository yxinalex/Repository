...
"
" For this, the alexdarkfull.vim, theme, this is defined as
let g:airline#themes#alexdarkfull#palette = {}

" Keys in the dictionary are composed of the mode, and if specified the
" override.  For example:
"   * g:airline#themes#alexdarkfull#palette.normal 
"       * the colors for a statusline while in normal mode
"   * g:airline#themes#alexdarkfull#palette.normal_modified 
"       * the colors for a statusline while in normal mode when the buffer has
"         been modified
"   * g:airline#themes#alexdarkfull#palette.visual 
...
" The alexdarkfull.vim theme:
" let s:airline_a_normal   = [ '#00005f' , '#dfff00' , 17  , 190 ]
" let s:airline_b_normal   = [ '#9e9e9e' , '#303030' , 247 , 236 ]
" let s:airline_c_normal   = [ '#ffffff' , '#121212' , 231 , 233 ]
let s:airline_a_normal   = [ '#00005f' , '#dfff00' , 17  , 190 ]
let s:airline_b_normal   = [ '#00005f' , '#00dfff' , 17  , 45  ]
let s:airline_c_normal   = [ '#EEEEEE' , '#005F87' , 231 , 24 ]
""" let s:airline_c_normal   = [ '#00005f' , '#005F87' , 17  , 24 ]
let g:airline#themes#alexdarkfull#palette.normal = airline#themes#generate_color_map(s:airline_a_normal, s:airline_b_normal, s:airline_c_normal)

" It should be noted the above is equivalent to:
" let g:airline#themes#alexdarkfull#palette.normal = airline#themes#generate_color_map(
...
" let g:airline#themes#alexdarkfull#palette.normal = {
...
" applied after g:airline#themes#alexdarkfull#palette.normal, hence why only certain keys are
" declared.
let g:airline#themes#alexdarkfull#palette.normal_modified = {
...
let g:airline#themes#alexdarkfull#palette.insert = airline#themes#generate_color_map(s:airline_a_insert, s:airline_b_insert, s:airline_c_insert)
let g:airline#themes#alexdarkfull#palette.insert_modified = {
      \ 'airline_c': [ '#ffffff' , '#5f005f' , 255     , 53      , ''     ] ,
      \ }
let g:airline#themes#alexdarkfull#palette.insert_paste = {
      \ 'airline_a': [ s:airline_a_insert[0]   , '#d78700' , s:airline_a_insert[2] , 172     , ''     ] ,
      \ }


let g:airline#themes#alexdarkfull#palette.replace = copy(g:airline#themes#alexdarkfull#palette.insert)
let g:airline#themes#alexdarkfull#palette.replace.airline_a = [ s:airline_b_insert[0]   , '#af0000' , s:airline_b_insert[2] , 124     , ''     ]
let g:airline#themes#alexdarkfull#palette.replace_modified = g:airline#themes#alexdarkfull#palette.insert_modified
...
let g:airline#themes#alexdarkfull#palette.visual = airline#themes#generate_color_map(s:airline_a_visual, s:airline_b_visual, s:airline_c_visual)
let g:airline#themes#alexdarkfull#palette.visual_modified = {
      \ 'airline_c': [ '#ffffff' , '#5f005f' , 255     , 53      , ''     ] ,
      \ }
...
let g:airline#themes#alexdarkfull#palette.inactive = airline#themes#generate_color_map(s:airline_a_inactive, s:airline_b_inactive, s:airline_c_inactive)
let g:airline#themes#alexdarkfull#palette.inactive_modified = {
      \ 'airline_c': [ '#875faf' , '' , 97 , '' , '' ] ,
      \ }
...
let g:airline#themes#alexdarkfull#palette.accents = {
      \ 'red': [ '#ff0000' , '' , 160 , ''  ]
      \ }
...
if get(g:, 'loaded_ctrlp', 0)
 let g:airline#themes#alexdarkfull#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(
